    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-10" style="margin:0 auto; float:none;">
          ...
          <h3 align="center">Kirim Pemberitahuan</h3>

          <div class="registrasi border p-2">

            <h4 align="center">Form Pemberitahuan</h4>     

            <form method="post" action="<?=base_url()?>index.php/instansi/send"  enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-md-12>
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="additional_information" placeholder="Isi Pemberitahuan" class="form-control" required rows="8"></textarea>
