...
<div class="col-md-12" style="background: white">
	<div class="row">
		<a href="<?=base_url('index.php/dashboard_user')?>" class="btn btn-primary">Belanja Lagi</a> <a href="#bayar" data-toggle="modal" onclick="simpan_list_db()" class="btn btn-warning">Bayar</a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      	...
      	<form method="post" id="upload_bukti" enctype="multipart/form-data">
      		...
      		<img src="<?=base_url()?>asset" id="loading" style="width:30px;float:left;display: none">
      		<span id="pesan1"></span>
		</div>
      	</form>
...
<script type="text/javascript">
	function load_cart(){
		...
		$.getJSON("<?=base_url()?>index.php/trans/tm_pesanan", function(hasil){
			...
			$("#tm_pesanan").append(
				'<tr>'+
				'<td colspan=3>Total keseluruhan</td><td align="right">'+hasil['total_seluruh']+'</td><td><a href="#" onclick="if(confirm(\'Aapakah Anda Yakin Menghapus data ini?\')){ hapus_all()}"><i class="material-icons">delete</i></a></td>'+
				'</tr>'
				);
		});
	}
