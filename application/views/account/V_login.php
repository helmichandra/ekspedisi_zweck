  ...
  <div class="limiter">
    <div class="container-login100">
      ...
      <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
        <form class="login100-form validate-form" action="<?=base_url()?>index.php/login/proses_login" method="POST">
          ...
          <div class="container-login100-form-btn">
            <div class="wrap-login100-form-btn">
              <div class="login100-form-bgbtn"></div>
                ...
                <button class="login100-form-btn" name="btnSubmit" value="Login">
                  Sign in
              </button>
              
            </div>

            <a href="<?=base_url()?>index.php/register" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
            Sign Up
