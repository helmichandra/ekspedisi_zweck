  ...
  <div class="limiter">
    <div class="container-login100">
      ...
      <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
        <form class="login100-form validate-form" action="<?=base_url()?>index.php/Login_user/simpan" method="POST">

        
      <?php echo form_open('Login_user/simpan');?>
          ...
          <div class="wrap-input100 validate-input" data-validate="Name is required">
            ...
            <input type="text" class="input100" name="nama" value="<?php echo set_value('nama'); ?>"/>
          ...
          <div class="container-login100-form-btn">
            <div class="wrap-login100-form-btn">
              <div class="login100-form-bgbtn"></div>
                ...
                <button class="login100-form-btn" name="btnSubmit" value="Daftar_user">
                 Confirm
              </button>
